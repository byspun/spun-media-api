...
import { kitsuDescription, kitsuRating, kitsuTitle, type KitsuAnime } from './meta/kitsu.js';
import type { MovieBoxInfo } from './meta/moviebox.js';
