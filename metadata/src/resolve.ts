...
import { getAnilistMedia, anilistTitle } from './meta/anilist.js';
import { getMovieboxInfoById } from './meta/moviebox.js';
import { getJikanAnimeDetail } from './meta/jikan.js';
import {
  getKitsuAnime,
